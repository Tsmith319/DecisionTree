...
def main():
	...
	for predictor in predictors:
		currPredictor = predictor[0]
		hundredPredictors.append(currPredictor)

	trainingGeneralBias, trainingGeneralVariance, trainingGeneralError = calculateBiasTerm(trainingDataSet, attributes, hundredPredictors, trainingLabels)
	testingGeneralBias, testingGeneralVariance, testingGeneralError = calculateBiasTerm(testingDataSet, attributes, hundredPredictors, testingLabels)
	...
	singleTree = hundredPredictors[random.randint(0,len(hundredPredictors)-1)]
